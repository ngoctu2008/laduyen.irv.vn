 ...
 */
function cartorder(a_ob, popup, url, module) {
    var id = $(a_ob).attr("id");
    if (popup == '0') {
        $.ajax({
            type: "GET",
            url: nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + module + '&' + nv_fc_variable + '=setcart' + '&id=' + id + "&nocache=" + new Date().getTime(),
            data: '',
            success: function(data) {
                ...
                if (strText != null) {
                    ...
                    alert_msg(strText);
                    $("#cart_" + module).load(nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + module + '&' + nv_fc_variable + '=loadcart');
                }
            }
        });
    } else {
...
function cartorder_detail(a_ob, popup, buy_now) {
    ...
    var group = '';
    var label = '';
    var title_setting = $('.filter_setting_price .border_red').attr('title_setting');
    var price_setting = $('.filter_setting_price .border_red').attr('price_setting');
    var id_setting_price = $('.filter_setting_price .border_red').attr('id_setting_price');
    ...
    $.ajax({
        type: "POST",
        url: nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=setcart' + '&id=' + id + "&title_setting=" + title_setting + "&price_setting=" + price_setting + "&id_setting_price=" + id_setting_price + "&group=" + group + "&nocache=" + new Date().getTime(),
        data: 'num=' + num,
        success: function(data) {
            var s = data.split('_');
            var strText = s[1];
