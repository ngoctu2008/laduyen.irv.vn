		...
		<table class="table-cart table">
			...
			<tbody>
				...
				<tr id="{id}_{list_group_id}">
					...
					<td class="table-title" style="display: flex;line-height: 1;align-items: center;width: auto;">
						<div class="cart_img">
							<a href="{link_pro}">
					...
					<!-- BEGIN: price2 -->
					<td class="money table-money text-right" style="min-width: 150px;">
					...
					<!-- END: price5 -->
					<td align="center"><a class="remove_cart" title="{LANG.cart_remove_pro}" href="{link_remove}"><em class="fa fa-times-circle">&nbsp;</em></a></td>
				</tr>
				<!-- END: rows -->
			</tbody>
		</table>
