    ...
    <form action="" method="post" name="fpost" id="fpost" class="form-horizontal">
        <div class="row">
            <div class="col-xs-24 col-sm-24 col-md-12 order_form">
                ...
                <div class="">
                    <div class="">
                        ...
                        <!-- BEGIN: order_address -->
                        <div class="form-group row">
                            <label class="col-sm-7 control-label">{LANG.order_address} <span class="error">(*)</span></label>
                            <div class="col-sm-17">
                        ...
                        <!-- END: order_address -->
                        <div class="form-group row">
                            <label class="col-sm-7 control-label">Tỉnh/thành <span class="error">(*)</span></label>
                            <div class="col-sm-17">
                                <select class="form-control tinhthanh" name="tinhthanh">
                                    <option value="0" required>-- Chọn tỉnh/thành --</option>
                                    <!-- BEGIN: tinh -->
                        ...
                        <div class="form-group row">
                            <label class="col-sm-7 control-label">Quận/huyện <span class="error">(*)</span></label>
                            <div class="col-sm-17">
                                <select class="form-control quanhuyen" name="quanhuyen">
                                    <option value="0" required>-- Chọn quận/huyện --</option>
                                    <!-- BEGIN: quan -->
                        ...
                        <div class="form-group row">
                            <label class="col-sm-7 control-label">Phường/xã <span class="error">(*)</span></label>
                            <div class="col-sm-17">
                                <select class="form-control xaphuong" name="xaphuong">
                                    <option value="0" required>-- Chọn phường/xã --</option>
                                    <!-- BEGIN: xa -->
            ...
            <div class="col-xs-24 col-sm-24 col-md-12 order_products">
                ...
                <div class="clear"></div>
                <!-- END: total_coupons -->
                <p class="text-right">{LANG.cart_total}: <strong id="total" data-total="{price_total}">{price_total}</strong> {unit_config}</p>
                <strong style="display:none" id="total_tam">{price_total}</strong>
                <!-- END: price3 -->
					<div class="margin-bottom-lg">
						<div class="radio_order">
							<input id="httt_nhanhang" type="radio" name="httt" value="Thanh toán khi nhận hàng" checked="" onclick="$('#content_payment').slideUp()">
							<label for="httt_nhanhang">Thanh toán khi nhận hàng</label>
						</div>
						<div class="radio_order">
							<input id="httt_chuyenkhoan" type="radio" name="httt" value="Thanh toán qua chuyển khoản" onclick="$('#content_payment').slideDown()">
							<label for="httt_chuyenkhoan">Thanh toán qua chuyển khoản</label>
							<div id="content_payment" style="display:none;transition:all 0s;">
								[THANHTOAN]
							</div>
						</div>
					</div>
                <div class="text-center">
					<div class="margin-bottom-lg hidden">
