...
{
    global $site_mods, $global_array_cat, $module_name, $module_upload, $lang_module, $module_config, $module_info, $catid, $page, $lang_global;
    ...
    foreach ($array_cat as $key => $array_row_i) {
        if (isset($array_cat[$key]['content'])) {
            ...
            foreach ($array_cat[$key]['content'] as $array_row_i) {
				...
				$array_row_i['hometext'] = nv_clean60(strip_tags($array_row_i['hometext']),200);
                ++$a;
