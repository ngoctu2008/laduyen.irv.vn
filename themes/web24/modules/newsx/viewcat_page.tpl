		...
		<div class="row"> 
			<div class="col-xs-24 col-sm-6">
				<div class="news_list-img ratio_4-3 hover_scale_img">
					<a href="{CONTENT.link}" title="{CONTENT.title}" {CONTENT.target_blank}><img  alt="{HOMEIMGALT1}" src="{HOMEIMG1}" width="{IMGWIDTH1}" class="lazy-img" /></a>
				</div>	
			</div>
			<div class="col-xs-24 col-sm-18">
				...
				<div class="news_list-viewmore">
					<a class="btn_cus -bg_white -green -brd_primary" href="{CONTENT.link}" title="{CONTENT.title}" {CONTENT.target_blank}>Xem thêm</a>
				</div>
				<!-- BEGIN: adminlink -->
				<p class="text-right">
					{ADMINLINK}
