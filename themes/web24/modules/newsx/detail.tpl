...
<div class="detail_title"><h1>{DETAIL.title}</h1></div>
...
<div class="news_column ">
	<div class=" other-news">
    	...
    	<!-- BEGIN: related_new -->
        <div class="news_detail-template-head font-utm"><span>{LANG.other}</span></div>
        <div class="news_list">
            <!-- BEGIN: loop -->
                ...
                <div class="row"> 
                    <div class="col-xs-10 col-sm-6">
                        <div class="news_list-img ratio_4-3 hover_scale_img">
                            <a href="{RELATED_NEW.link}" {RELATED_NEW.target_blank} title="{RELATED_NEW.title}"><img alt="{RELATED_NEW.title}" data-src="{RELATED_NEW.imghome}" class="lazy-img" /></a>
                        </div>  
                    </div>
