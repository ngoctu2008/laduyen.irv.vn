<form action="{USER_LOGIN}" method="post" onsubmit="return login_validForm(this);" autocomplete="off" novalidate>
    <div class="nv-info margin-bottom hidden" data-default="{GLANG.logininfo}">{GLANG.logininfo}</div>
        ...
        <!-- BEGIN: openid -->
       	<div class="text-center openid-btns">
            ...
            <div class="btn-group m-bottom">
                <button class="btn openid-logo-{OPENID.server}" type="button" tabindex="-1"><i class="fa fa-fw fa-{OPENID.icon}"></i></button>
