<form action="{USER_REGISTER}" method="post" onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
    <div class="nv-info margin-bottom hidden" data-default="{LANG.info}">{LANG.info}</div>
    ...
    <div class="form-detail">
        ...
        <!-- BEGIN: reg_recaptcha -->
        <div class="form-group">
            <div class="middle text-center clearfix d-xs-flex justify-content-xs-center align-items-xs-center">
